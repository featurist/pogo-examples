...
if (module && module.exports) {
  hljs.LANGUAGES.javascript = require(__dirname + '/javascript').javascript(hljs)
  hljs.LANGUAGES.pogoscript = require(__dirname + '/pogoscript').pogoscript(hljs)

  exports.javascript = function(text) {
    return hljs.highlight('javascript', text).value;
  }
  
  exports.pogoscript = function(text) {
    return hljs.highlight('pogoscript', text).value;
  }
}
